...
url = 'https://raw.githubusercontent.com/dougmassay/ncxremove-sigil-plugin/master/checkversion.xml'
delta = 12
...
def main():
    class w():
        def __init__(self):
            w.plugin_name = 'NCXRemove'
            w.plugin_dir = os.path.join(os.path.expanduser('~'), '.local/share/sigil-ebook/sigil/plugins')
